  ...
  return (
    ...
    >
      <div ref={contentRef} className="w-full max-w-md flex flex-col items-center text-center">
        ...
        <p className="font-serif text-[1.5rem] leading-relaxed text-primary mb-8">
          В этой истории пока написаны<br/>только две главы.
        </p>

        <p className="font-serif text-[1.5rem] leading-relaxed text-primary mb-16">
          Но впереди у нас — целая жизнь.
        </p>

        <div className="text-4xl mb-16 animate-pulse drop-shadow-md">
          ❤️
        </div>
