...
const REASONS = [
  ...
  'Твоя доброта — самая искренняя и настоящая.',
  'С тобой мне хочется жить, а не просто существовать.',
  'Ты — лучшее, что со мной случалось.',
  'Я люблю смотреть на то, как ты спишь перед тем, как идти на работу.',
